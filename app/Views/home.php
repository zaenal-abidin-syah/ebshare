...
<section>
  ...
  <!-- SVG Background -->
  <span class="[&>svg]:-z-10 relative top-0 left-0 right-0 [&>svg]:m-auto [&>svg]:block [&>svg]:w-full">
    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" height="680" preserveAspectRatio="none" viewBox="0 0 1920 880">
      <g transform="translate(960,440) scale(1,1) translate(-960,-440)">
        <linearGradient id="lg-0.047955344060927496" x1="0" x2="1" y1="0" y2="0">
          ...
          <stop stop-color="hsl(271, 81%, 56%)" offset="0"></stop>
          <stop stop-color="hsl(269, 100%, 95%)" offset="1"></stop>
        </linearGradient>
  ...
  <!-- Jumbotron -->
  <div class="absolute top-0 right-0 left-0 bottom-0 w-100 mx-auto px-6 sm:max-w-2xl md:max-w-3xl md:px-12 lg:max-w-5xl xl:max-w-7xl xl:px-32">
    <div class="text-center">
      <div class="block rounded-lg bg-[hsla(0,0%,100%,0.8)] px-6 py-12 shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:bg-[hsla(0,0%,15%,0.8)] dark:shadow-black/20 md:py-16 md:px-12" style="
              margin-top: 180px;
              backdrop-filter: saturate(200%) blur(25px);
            ">
        <h1 class="mt-6 mb-16 text-5xl font-bold tracking-tight md:text-6xl xl:text-7xl">
          Bersama Ebshare <br /><span class="text-purple">Berbagi Ebook Tanpa Batas</span>
        </h1>
        <a class="mb-2 inline-block rounded bg-blue-400 px-12 pt-4 pb-3.5 text-sm font-medium uppercase leading-normal text-white shadow-[0_4px_9px_-4px_#3b71ca] transition duration-150 ease-in-out hover:bg-purple-600 hover:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.3),0_4px_18px_0_rgba(59,113,202,0.2)] focus:bg-purple-600 focus:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.3),0_4px_18px_0_rgba(59,113,202,0.2)] focus:outline-none focus:ring-0 active:bg-purple-700 active:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.3),0_4px_18px_0_rgba(59,113,202,0.2)] dark:shadow-[0_4px_9px_-4px_rgba(59,113,202,0.5)] dark:hover:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.2),0_4px_18px_0_rgba(59,113,202,0.1)] dark:focus:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.2),0_4px_18px_0_rgba(59,113,202,0.1)] dark:active:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.2),0_4px_18px_0_rgba(59,113,202,0.1)] md:mr-2 md:mb-0" data-te-ripple-init data-te-ripple-color="light" href="#!" role="button">Get started</a>
        <a class="inline-block rounded px-12 pt-4 pb-3.5 text-sm font-medium uppercase leading-normal text-purple-700 transition duration-150 ease-in-out hover:bg-neutral-500 hover:bg-opacity-10 hover:text-purple-600 focus:text-purple-600 focus:outline-none focus:ring-0 active:text-purple-700 dark:hover:bg-neutral-700 dark:hover:bg-opacity-40" data-te-ripple-init data-te-ripple-color="light" href="#!" role="button">Learn more</a>
      </div>
    </div>
  </div>
  <!-- Jumbotron -->
...
<!-- Jumlah semua unduhan favorite dan komentar -->
<div class="mt-10 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4">
  <div class="relative mb-12 px-3 text-center lg:mb-0">
  ...
  <div class="relative mb-12 text-center px-3 lg:mb-0">
    <div class="mb-2 flex justify-center">
      <span class="text-purple">
        <!-- <svg
              xmlns="http://www.w3.org/2000/svg"
