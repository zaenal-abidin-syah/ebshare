...
<!-- hero section -->
      ...
      >
        <div class="text-center">
          ...
          >
            ...
            >
              The best offer on the market <br /><span class="text-purple"
    ...
    <div class="mt-10 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4">
      <div class="relative mb-12 px-3 lg:mb-0">
        ...
        <h5 class="mb-6 font-bold text-purple">5000+</h5>
      ...
      <div class="relative mb-12 px-3 lg:mb-0">
        ...
        <h5 class="mb-6 font-bold text-purple">490+</h5>
      ...
      <div class="relative mb-12 px-3 lg:mb-0">
        ...
        <h5 class="mb-6 font-bold text-purple">100+</h5>
      ...
      <div class="relative mb-12 px-3 lg:mb-0">
        ...
        <h5 class="mb-6 font-bold text-purple">28</h5>
    ...
    <nav aria-label="Page navigation example">
      <ul class="list-style-none flex">
        ...
        <li aria-current="page">
          <a
            class="relative block rounded bg-purple-100 px-5 py-3 text-lg font-medium text-purple-700 transition duration-300 focus:outline-none dark:bg-slate-900 dark:text-purple-500"
            href="#!"
            >2
