...
<!-- hero section -->
    ...
    <section>
      ...
      <!-- SVG Background -->
      <span
        class="[&>svg]:-z-10 relative top-0 left-0 right-0 [&>svg]:m-auto [&>svg]:block [&>svg]:w-full"
      >
        <svg
      ...
      <!-- Jumbotron -->
      <div
        class="absolute top-0 right-0 left-0 bottom-0 w-100 mx-auto px-6 sm:max-w-2xl md:max-w-3xl md:px-12 lg:max-w-5xl xl:max-w-7xl xl:px-32"
      >
        <div class="text-center">
          ...
          >
            ...
            >
            <a
              class="inline-block rounded px-12 pt-4 pb-3.5 text-sm font-medium uppercase leading-normal text-purple-700 transition duration-150 ease-in-out hover:bg-neutral-500 hover:bg-opacity-10 hover:text-purple-600 focus:text-purple-600 focus:outline-none focus:ring-0 active:text-purple-700 dark:hover:bg-neutral-700 dark:hover:bg-opacity-40"
              data-te-ripple-init
              data-te-ripple-color="light"
              href="#!"
              role="button"
    ...
    <div class="mt-10 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4">
      <div class="relative mb-12 px-3 lg:mb-0">
        ...
        <h5 class="mb-6 font-bold text-purple"><?= $statistik[0]['ebooks'] ?></h5>
        <h6 class="mb-0 font-normal dark:text-neutral-50">Ebooks</h6>
        <div
      ...
      <div class="relative mb-12 px-3 lg:mb-0">
        ...
        <h5 class="mb-6 font-bold text-purple"><?= $statistik[0]['user'] ?></h5>
        <h6 class="mb-0 font-normal dark:text-neutral-50">User</h6>
        <div
          class="absolute right-0 top-0 hidden h-full min-h-[1em] w-px self-stretch border-t-0 bg-gradient-to-tr from-transparent via-neutral-500 to-transparent opacity-25 dark:via-neutral-400 lg:block"
        ></div>
      </div>
      <div class="relative mb-12 px-3 lg:mb-0">
        ...
        <h5 class="mb-6 font-bold text-purple"><?= $statistik[0]['jumlah_unduhan'] ?></h5>
        <h6 class="mb-0 font-normal dark:text-neutral-50">Unduhan</h6>
        <div
          class="absolute right-0 top-0 hidden h-full min-h-[1em] w-px self-stretch border-t-0 bg-gradient-to-tr from-transparent via-neutral-500 to-transparent opacity-25 dark:via-neutral-400 lg:block"
        ></div>
      </div>
      <div class="relative mb-12 px-3 lg:mb-0">
        ...
        <h5 class="mb-6 font-bold text-purple"><?= $statistik[0]['jumlah_komentar'] ?></h5>
        <h6 class="mb-0 font-normal dark:text-neutral-50">Komentar</h6>
      </div>
    </div>
