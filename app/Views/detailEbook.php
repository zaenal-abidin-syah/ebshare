                  ...
                  <table class="min-w-[90%] mx-auto text-left text-sm font-light text-surface">
                    ...
                    <tbody>
                      ...
                      <tr class="border-b border-neutral-200 bg-black/[0.02]">
                        ...
                        <td class="whitespace-nowrap px-8 py-6">
                          <div id="ratingApp">
                            <div id="starsContainer" class="my-1 flex list-none w-[50%] sm:w-[40%] md:w-[30%] lg:w-[15%] gap-1 p-0">
                          ...
                          <article class="p-6 mb-3 text-base bg-white border-t border-gray-200 dark:border-gray-700 dark:bg-gray-900">
                            <footer class="flex justify-between items-center mb-2">
                              <div class="flex items-center">
                                <p class="inline-flex items-center mr-3 text-sm text-gray-900 dark:text-white font-semibold"><img class="mr-2 w-6 h-6 rounded-full" src="https://flowbite.com/docs/images/people/profile-picture-3.jpg" alt="Bonnie Green"><?= $komen['user'] ?></p>
                                <p class="text-sm text-gray-600 dark:text-gray-400"><time pubdate datetime="<?= $komen['tanggal'] ?>" title="March 12th, 2022"><?= $komen['tanggal'] ?></time></p>
                              </div>
                            ...
                            <p class="text-gray-500 dark:text-gray-400"><?= $komen['komentar'] ?></p>
      ...
      $.ajax({
        ...
        success: function(response) {
          ...
          if (response.status === 'success') {
            response.komentar.forEach(k => {
              dataKomentar += `<article class="p-6 mb-3 text-base bg-white border-t border-gray-200 dark:border-gray-700 dark:bg-gray-900">
                          <footer class="flex justify-between items-center mb-2">
                            <div class="flex items-center">
                              <p class="inline-flex items-center mr-3 text-sm text-gray-900 dark:text-white font-semibold"><img class="mr-2 w-6 h-6 rounded-full" src="https://flowbite.com/docs/images/people/profile-picture-3.jpg" alt="Bonnie Green">${k.user}</p>
                              <p class="text-sm text-gray-600 dark:text-gray-400"><time pubdate datetime="${k.tanggal}" title="March 12th, 2022">${k.tanggal}</time></p>
                            </div>
                            <button id="dropdownComment3Button" data-dropdown-toggle="dropdownComment3" class="inline-flex items-center p-2 text-sm font-medium text-center text-gray-500 dark:text-gray-40 bg-white rounded-lg hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-gray-50 dark:bg-gray-900 dark:hover:bg-gray-700 dark:focus:ring-gray-600" type="button">
                              <svg class="w-4 h-4" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 16 3">
                                <path d="M2 0a1.5 1.5 0 1 1 0 3 1.5 1.5 0 0 1 0-3Zm6.041 0a1.5 1.5 0 1 1 0 3 1.5 1.5 0 0 1 0-3ZM14 0a1.5 1.5 0 1 1 0 3 1.5 1.5 0 0 1 0-3Z" />
