...
<html lang="en">
  ...
  <body>
    ...
    <nav
      class="fixed z-10 top-0 left-0 right-0 flex-no-wrap flex w-full px-10 items-center justify-between bg-purple-600 py-2 shadow-dark-mild dark:bg-purple-800 lg:flex-wrap lg:justify-start lg:py-4"
    >
