                    ...
                    <tbody>
                      <?php foreach ($ebooks as $ebook) { ?>
                        ...
                        <td class="p-2 align-middle bg-transparent border-b dark:border-white/40 whitespace-nowrap shadow-transparent">
                          ...
                          <a href="<?= base_url('/dashboard/ebook/delete/'.$ebook['id']) ?>" class="text-xs mx-1 text-white bg-gradient-to-tl from-red-500 to-yellow-400 inline-block whitespace-nowrap rounded-full px-[0.7em] pb-[0.25em] pt-[0.35em] text-center align-baseline text-[0.75em] font-bold"> Delete </a>
                        </td>
                      </tr>
                        <?php } ?>
