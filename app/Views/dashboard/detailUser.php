        ...
        <div class="p-6 pb-0 mb-0 border-b-0 border-b-solid rounded-t-2xl border-b-transparent">
          <div class="flex justify-between mx-[15%] items-center px-5 pt-0 pb-2">
            ...
            <a
              ...
              href="<?= base_url('dashboard/user/edit/').$detail['id'] ?>"
          ...
          <div class="overflow-x-auto sm:-mx-6 lg:-mx-8">
            <div class="inline-block min-w-full py-2 sm:px-6 lg:px-8">
              <div class="overflow-hidden">
                <table
                  class="min-w-[90%] mx-auto text-left text-sm font-light text-surface">
                  <thead
                  ...
                  <tbody>
                    <tr
                      ...
                      <td class="whitespace-nowrap px-8 py-6"><?= $detail['username'] ?></td>
                    </tr>
                    <tr
                      class="border-b border-neutral-200 bg-white ">
                      <td class="whitespace-nowrap px-8 py-6">Email</td>
                      <td class="whitespace-nowrap px-8 py-6"><?= $detail['email'] ?></td>
                    </tr>
                    <tr
                      class="border-b border-neutral-200 bg-black/[0.02]">
                      <td class="whitespace-nowrap px-8 py-6">Role</td>
                      <td class="whitespace-nowrap px-8 py-6"><?= $detail['role'] == '1' ? 'admin' : 'user' ?></td>
                    </tr>
                    <tr
                      class="border-b border-neutral-200 bg-white ">
                      <td class="whitespace-nowrap px-8 py-6">Tanggal Bergabung</td>
                      <td class="whitespace-nowrap px-8 py-6"><?= $detail['tanggal_bergabung'] ?></td>
                    </tr>
                    <tr
                      class="border-b border-neutral-200 bg-black/[0.02]">
                      <td class="whitespace-nowrap px-8 py-6">No Telepon</td>
                      <td class="whitespace-nowrap px-8 py-6"><?= $detail['no_telepon'] ?></td>
                    </tr>
                    <tr
                      class="border-b border-neutral-200 bg-white ">
                      <td class="whitespace-nowrap px-8 py-6">Alamat</td>
                      <td class="whitespace-nowrap px-8 py-6"><?= $detail['alamat'] ?></td>
                    </tr>
                    <tr
                      class="border-b border-neutral-200 bg-black/[0.02]">
                      <td class="whitespace-nowrap px-8 py-6">Kota</td>
                      <td class="whitespace-nowrap px-8 py-6"><?= $detail['kota'] ?></td>
                    </tr>
                    <tr
                      class="border-b border-neutral-200 bg-white ">
                      <td class="whitespace-nowrap px-8 py-6">Provinsi</td>
                      <td class="whitespace-nowrap px-8 py-6"><?= $detail['provinsi'] ?></td>
                    </tr>
                    <tr
                      class="border-b border-neutral-200 bg-black/[0.02]">
                      <td class="whitespace-nowrap px-8 py-6">Negara</td>
                      <td class="whitespace-nowrap px-8 py-6"><?= $detail['negara'] ?></td>
                    </tr>
                  </tbody>
                </table>
              </div>
