...
$routes->post('/dashboard/ebook/add', 'Dashboard::create');
$routes->get('/dashboard/ebook/edit', 'Dashboard::edit');
$routes->get('/dashboard/ebook/delete/(:any)', 'Dashboard::delete/$1');
